...
export default function NearbySection() {
    return (
        ...
        <span style={{display: "flex", justifyContent: "space-around"}}>
            <ListItem>
           <Typography  variant="body2" >Fewa Lake</Typography>
              </ListItem>
              <ListItem>
           <Typography  variant="body2"  color="textSecondary"> 0.6km</Typography>
            ...
            <span style={{display: "flex", justifyContent: "space-around"}}>
            <ListItem>
           <Typography  variant="body2" >World Peace Pagoda</Typography>
              </ListItem>
              <ListItem>
           <Typography  variant="body2"   color="textSecondary"> 0.6km</Typography>
              </ListItem>
            ...
            <span style={{display: "flex", justifyContent: "space-around"}}>
            <ListItem>
           <Typography  variant="body2" >Begnas Lake</Typography>
              </ListItem>
              <ListItem>
           <Typography  variant="body2"   color="textSecondary"> 0.6km</Typography>
              </ListItem>
            ...
            <span style={{display: "flex", justifyContent: "space-around"}}>
            <ListItem>
           <Typography  variant="body2" >International Mountain Museum</Typography>
              </ListItem>
              <ListItem>
